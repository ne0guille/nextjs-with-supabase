    ...
    <footer className="w-full border-t border-t-foreground/10 flex justify-center text-center text-xs">
      <div className="container p-4 mx-auto flex items-center sm:flex-row flex-col">
        <a className="flex title-font font-medium items-center md:justify-start justify-center text-gray-900">
          ...
          <span className="ml-3 text-xl">CodeBreakout</span>
        </a>
        <p className="text-sm text-gray-500 sm:ml-4 sm:pl-4 sm:border-l-2 sm:border-gray-200 sm:py-2 sm:mt-0 mt-4">
          © 2023 CodeBreakout —
          <a
            href="https://x.com/codebreakout"
        ...
        {/* <span className="inline-flex sm:ml-auto sm:mt-2 mt-4 justify-center sm:justify-start align-center">
